@extends('layouts.app',['page' => 'service','text' => 'Danh sách dịch vụ'])
@section('content')
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                    ...
                    @foreach($data as $index => $service)
                        <tr>
                            ...
                            <td>{{ ++$index }}</td>
                            <td>{{ $service->name }}</td>
                            <td><a href="{{ route('admin.category.edit', ['id' => $service['category']['id']]) }}"
                                   class="kt-badge kt-badge--brand kt-badge--inline kt-badge--pill kt-badge--rounded">{{ $service['category']['title'] }}</a>
                            </td>
                            <td><span
                                    class="kt-badge kt-badge--brand kt-badge--inline kt-badge--pill kt-badge--rounded">{{ $service['created_user']['name'] }}</span>
                            </td>
                            <td>{{ $service->created_at->format('h:i:s - d/m/Y') }}</td>
