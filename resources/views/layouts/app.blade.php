...
<!-- begin:: Header Mobile -->
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed" style="background: white;">
    <div class="kt-header-mobile__logo">
        <a href="{{ route('admin.dashboard.index') }}">
            <img alt="Logo" style="width: 50%;height: 45px;" src="{{ asset('image/netvas (1).png') }}"/>
        </a>
    </div>
...
-->
        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
            ...
            <!-- begin:: Aside -->
            <div class="kt-aside__brand kt-grid__item " style="background: white;" id="kt_aside_brand">
                <div class="kt-aside__brand-logo">
                    <a href="{{ route('admin.dashboard.index') }}">
                        <img alt="Logo" src="{{ asset('image/netvas (1)-Recovered.png') }}"
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                    ...
                    <ul class="kt-menu__nav ">
                        @can('dashboard')
                            <li class="kt-menu__item {{ sidebar_active($page,'dashboard') }}" aria-haspopup="true"><a
                        ...
                        @endcan
                        @can('page')
                            <li class="kt-menu__item {{ sidebar_active($page,'page|page.create|page.edit') }}"
...
</svg></span><span class="kt-menu__link-text">Trang</span></a></li>
                        @endcan
                        @can('page')
                            <li class="kt-menu__item {{ sidebar_active($page,'notification') }}"
                                aria-haspopup="true"><a
...
</svg></span><span class="kt-menu__link-text">Thông báo</span></a></li>
                        @endcan
                        @if($user->group->type == 'staff')
                            <li class="kt-menu__item {{ sidebar_active($page,'staff|staff.detail') }}"
                                aria-haspopup="true"><a
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
...
</svg></span><span class="kt-menu__link-text">Staff</span></a></li>
                        @endif
                        @if($user->can('category') || $user->can('category-create') )
                            <li class="kt-menu__item  {{ sidebar_active($page,'category|category.create|category.edit',true) }}"
                                aria-haspopup="true"
                                data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                        ...
                                        class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
											...
											</svg></span><span class="kt-menu__link-text">Chuyên mục</span><i
                                ...
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        @can('category-create')
                                            <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'category.create') }}"
                                                aria-haspopup="true"><a
                                                    href="{{ route('admin.category.create') }}"
                                                    class="kt-menu__link"><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                        class="kt-menu__link-text">Thêm chuyên mục</span></a>
                                            </li>
                                        @endcan
                                        @can('category')
                                            <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'category') }}"
                                                aria-haspopup="true"><a
                                                    href="{{ route('admin.category.index') }}"
                                                    class="kt-menu__link"><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                        class="kt-menu__link-text">Danh sách chuyên mục</span></a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                        ...
                        @endif
                        @if($user->can('service') || $user->can('service-create') )
                            <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'service|service.create|service.edit',true) }}"
                                aria-haspopup="true"
                                data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                                      class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" fill-rule="nonzero"/>
...
</svg></span><span class="kt-menu__link-text">Dịch vụ</span><i
                                        class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                                                class="kt-menu__link"><span
                                                    class="kt-menu__link-text">Dịch vụ</span></span>
                                        </li>
                                        @can('service-create')
                                            <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'service.create') }}"
                                                aria-haspopup="true"><a
                                                    href="{{ route('admin.service.create') }}"
                                                    class="kt-menu__link"><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                        class="kt-menu__link-text">Thêm dịch vụ</span></a>
                                            </li>
                                        @endcan
                                        @can('service')
                                            <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'service') }}"
                                                aria-haspopup="true"><a
                                                    href="{{ route('admin.service.index') }}"
                                                    class="kt-menu__link"><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                        class="kt-menu__link-text">Danh sách dịch vụ</span></a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                        ...
                        @endif
                        @can('booking')
                            <li class="kt-menu__item {{ sidebar_active($page,'booking|booking.detail|booking.create') }}"
                                aria-haspopup="true"><a
...
</svg></span><span class="kt-menu__link-text">Đơn hàng</span></a></li>
                        @endcan
                        @can('ranking')
                            <li class="kt-menu__item {{ sidebar_active($page,'ranking') }}"
                                aria-haspopup="true"><a
...
</svg></span><span class="kt-menu__link-text">Bảng xếp hạng</span></a></li>
                        @endcan
                        @can('rating')
                            <li class="kt-menu__item {{ sidebar_active($page,'rating') }}"
                                aria-haspopup="true"><a
...
</svg></span><span class="kt-menu__link-text">Đánh giá</span></a></li>
                        @endcan
                        @can('request-support')
                            <li class="kt-menu__item {{ sidebar_active($page,'request-support|request-support.detail') }}"
                                aria-haspopup="true"><a
                                    href="{{ route('admin.request-support.index') }}"
                                    class="kt-menu__link "><span
                                        class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        width="24px" height="24px" viewBox="0 0 24 24"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000"/>
...
</svg></span><span class="kt-menu__link-text">Hỗ trợ</span></a></li>
                        @endcan
                        @if($user->can('user') || $user->can('user-create') )
                            <li class="kt-menu__item {{ sidebar_active($page,'user|user.create|user.edit',true) }} kt-menu__item--submenu"
                                aria-haspopup="true"
                                data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                                      class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            </svg></span><span class="kt-menu__link-text">Tài khoản</span><i
                                        class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                                                class="kt-menu__link"><span
                                                    class="kt-menu__link-text">Tài khoản</span></span>
                                        </li>
                                        @can('user-create')
                                            <li class="kt-menu__item {{ sidebar_active($page,'user.create') }} kt-menu__item--submenu"
                                                aria-haspopup="true"><a
                                                    href="{{ route('admin.user.create') }}"
                                                    class="kt-menu__link"><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                        class="kt-menu__link-text">Thêm tài khoản</span></a>
                                            </li>
                                        @endcan
                                        @can('user')
                                            <li class="kt-menu__item {{ sidebar_active($page,'user') }} kt-menu__item--submenu"
                                                aria-haspopup="true"><a
                                                    href="{{ route('admin.user.index') }}"
                                                    class="kt-menu__link"><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                        class="kt-menu__link-text">Danh sách tài khoản</span></a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                        ...
                        @endif
                        @if($user->can('group-create') || $user->can('group') )
                            <li class="kt-menu__item {{ sidebar_active($page,'group|group.create|group.edit',true) }} kt-menu__item--submenu"
                                aria-haspopup="true"
                                data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                                      class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                </svg></span><span class="kt-menu__link-text">Nhóm tài khoản</span><i
                                        class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                                                class="kt-menu__link"><span
                                                    class="kt-menu__link-text">Nhóm tài khoản</span></span>
                                        </li>
                                        @can('group-create')
                                            <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'group.create') }}"
                                                aria-haspopup="true"><a
                                                    href="{{ route('admin.group.create') }}"
                                                    class="kt-menu__link"><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                        class="kt-menu__link-text">Thêm nhóm tài khoản</span></a>
                                            </li>
                                        @endcan
                                        @can('group')
                                            <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'group') }}"
                                                aria-haspopup="true"><a
                                                    href="{{ route('admin.group.index') }}"
                                                    class="kt-menu__link"><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                        class="kt-menu__link-text">Danh sách nhóm tài khoản</span></a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                        ...
                        @endif
                        {{--
                    @if($user->can('role-create') || $user->can('role') )
                        <li class="kt-menu__item {{ sidebar_active($page,'role|role.create|role.edit',true) }} kt-menu__item--submenu"
                            aria-haspopup="true"
                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                                  class="kt-menu__link kt-menu__toggle"><span
                                    class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
...
<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <path
        ...
        fill="#000000"/>
...
</svg></span><span class="kt-menu__link-text">Luật</span><i
                                    class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                <ul class="kt-menu__subnav">
                                    <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                                            class="kt-menu__link"><span
                                                class="kt-menu__link-text">Luật</span></span>
                                    </li>
                                    @can('role-create')
                                        <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'role.create') }}"
                                            aria-haspopup="true"><a
                                                href="{{ route('admin.role.create') }}"
                                                class="kt-menu__link"><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Thêm luật</span></a>
                                        </li>
                                    @endcan
                                    @can('role')
                                        <li class="kt-menu__item  kt-menu__item--submenu {{ sidebar_active($page,'role') }}"
                                            aria-haspopup="true"><a
                                                href="{{ route('admin.role.index') }}"
                                                class="kt-menu__link"><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Danh sách luật</span></a>
                                        </li>
                                    @endcan
                                </ul>
                            </div>
                    ...
                    --}}
                        @can('setting')
                            <li class="kt-menu__item {{ sidebar_active($page,'setting') }}"
                                aria-haspopup="true"><a
...
</svg></span><span class="kt-menu__link-text">Cài đặt hệ thống</span></a></li>
                        @endcan
                    </ul>
                </div>
            </div>
                        ...
                        {{--<ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                                                                                           class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-text">Chuyên mục</span><i
                                        class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                                                                                           class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-text">Dịch vụ</span><i
                                        class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                                                                                           class="kt-menu__link kt-menu__toggle"><span
                                        class="kt-menu__link-text">Tài khoản</span><i
                                        class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item " aria-haspopup="true"><a href="javascript:;"
            ...
            -->
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active show" data-toggle="tab"
                                               ...
                                               aria-selected="true">Đơn hàng mới</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-pane active show" id="topbar_notifications_notifications"
                                        ...
                                        <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll"
                                             ...
                                             data-mobile-height="200">
                                                @foreach( booking_notifications() as $booking)
                                                    <a href="{{ route('admin.booking.detail',['id' => $booking->id]) }}" class="kt-notification__item">
                                                        <div class="kt-notification__item-details">
                                                            <div class="kt-notification__item-title">
                                                                #{{ $booking->booking_code }} <span class="kt-badge kt-badge--warning kt-badge--inline text-white ml-2">mới tạo</span>
                                                            </div>
                                                            <div class="kt-notification__item-time">
                                                                {{ $booking->created_at->format('H:i:s d-m-Y') }}
                                                            </div>
                                                        </div>
                                                    </a>
                                                @endforeach
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                            <div class="kt-header__topbar-user px-3">
                                <span
                                    class="kt-header__topbar-username kt-hidden-mobile px-0">{{ $user->name }}</span>
                        ...
                        <div
                            ...
                            <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x"
                                ...
                                <div class="kt-user-card__name pl-0">
                                    {{ auth()->user()->name }}
                                </div>
                            </div>
                            ...
                            <div class="kt-notification">
                                ...
                                <div class="kt-notification__custom kt-space-between">
                                    <a href="{{ url('/logout') }}"
                                       class="btn btn-label btn-label-brand btn-sm btn-bold">Đăng
                                        xuất
                                    </a>
                                </div>
                            </div>
...
<script>
    ...
    OneSignal.push(function () {
        OneSignal.init({
            appId: "1bf1d550-c0e1-4aa3-9477-1eca9fa85b8c",
        });
    });
</script>
<script>
                ...
                if (isSubscribed) {
                    OneSignal.getUserId(function (userId) {
                        ...
                        if (userId) {
                            console.log('userId', userId);
                            $.ajax({
                                url: '{{ route('admin.onesignal.update') }}',
                                type: 'POST',
                                data: {user_id: userId},
                                headers: {
