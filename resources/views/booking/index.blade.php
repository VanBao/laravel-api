@extends('layouts.app',['page' => 'booking','text' => 'Danh sách đơn hàng'])
@section('content')
										...
										<div class="kt-chat__head ">
											...
											<div class="kt-chat__center">
												<div class="kt-chat__label kt-hidden">
													...
													<span
														class="kt-badge kt-badge--dot kt-badge--success"></span> Active
													</span>
												</div>
											</div>
										</div>
...
<!--begin::Modal-->
<div class="modal fade" id="user_info" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Chi tiết đơn hàng: <span
					class="font-weight-light netvas-customer_name">asdasdasdasd</span></h5>
				...
				<div class="kt-notification-v2">
					<a href="#" class="kt-notification-v2__item">
						...
						<div class="kt-notification-v2__itek-wrapper">
							...
							<div class="kt-notification-v2__item-title netvas-booking_code">
							</div>
						</div>
					</a>
					<a href="#" class="kt-notification-v2__item">
						...
						<div class="kt-notification-v2__itek-wrapper">
							...
							<div class="kt-notification-v2__item-title netvas-customer_name">
							</div>
						</div>
					</a>
					<a href="#" class="kt-notification-v2__item">
						...
						<div class="kt-notification-v2__itek-wrapper">
							...
							<div class="kt-notification-v2__item-title netvas-customer_phone">
							</div>
						</div>
					</a>
					<a href="#" class="kt-notification-v2__item">
						<div class="kt-notification-v2__item-icon">
							<i class="flaticon2-email kt-font-success"></i>
						</div>
						<div class="kt-notification-v2__itek-wrapper">
							<div class="kt-notification-v2__item-desc">
								Email khách hàng
							</div>
							<div class="kt-notification-v2__item-title netvas-customer_email">
							</div>
						</div>
					</a>
					<a href="#" class="kt-notification-v2__item">
						<div class="kt-notification-v2__item-icon">
							<i class="flaticon2-map kt-font-success"></i>
						</div>
						<div class="kt-notification-v2__itek-wrapper">
							<div class="kt-notification-v2__item-desc">
								Địa chỉ khách hàng
							</div>
							<div class="kt-notification-v2__item-title netvas-customer_address">
							</div>
						</div>
					</a>
					<a href="#" class="kt-notification-v2__item">
						...
						<div class="kt-notification-v2__itek-wrapper">
							...
							<div class="kt-notification-v2__item-title netvas-images">
							</div>
						</div>
					</a>
				</div>
...
{{--@php--}}
{{--    $status = '#ffffff';--}}
{{--    if($booking->booking_status == 'create') {--}}
{{--        $status = '#ffefb5ad';--}}
...
<script type="text/javascript">
	var KTDB_URL = '{{ route('admin.booking.pagination') }}';
	var DETAIL_URL = '{{ route('admin.booking.detail',':id') }}';
	var DELETE_URL = '{{ route('admin.booking.delete',':id') }}'
	var KTDB_COLUMNS = [
	    {
	        field: 'booking_code',
	        title: 'Mã đơn hàng',
	    ...
	    },
	    {
	        ...
	        template: function(data, index){
	            return data['city'] && data['city']['name'] ? data['city']['name'] : '';
	        }
	    },
	    {
	...
	\<a href="' + DELETE_URL.replace(':id', data.id) + '" class="btn btn-sm btn-clean btn-icon btn-icon-sm btn-booking-delete" title="Edit details">\
...
<script type="text/javascript">
	jQuery(document).ready(function () {
	    ...
	    $('#kt_form_city').on('change', function () {
	        datatable.search($(this).val().toLowerCase(), 'city_id');
	    });
	    ...
	    $('#kt_form_status, #kt_form_city, #kt_form_type,#kt_form_action').selectpicker();
	
	    $("#ajax_data").on('click', '.btn-booking-delete', function () {
